...
| 问卷题目 | 19 | 预计完成时间 6–9 分钟；18 道封闭题共 121 个选项，详细信息集中在 4 道开发核心题 |
...
| 文档 | 内容 | 建议用途 |
| --- | --- | --- |
| [量子化学结果交付与三维场可视化需求调查](docs/survey/quantum_chemistry_software_survey_draft_2026-07-19.md) | 19 道文献与产品决策支撑的预测试题目；选项按开发决策合并，仅场类型、文件格式、可视化风险和功能优先级保留较细粒度 | 认知访谈、预测试和正式投放前校准 |
...
| [问卷受众扩展设计](docs/superpowers/specs/2026-07-20-broaden-survey-audience-design.md) | 18 题角色分流方案、保留项和分析口径 | 了解受众扩展依据 |
| [问卷受众扩展实施计划](docs/superpowers/plans/2026-07-20-broaden-survey-audience.md) | Markdown 改版、旧工作簿退役和验证步骤 | 追溯本轮改版过程 |
| [问卷选项减负与 ChemBlender 2.1 衔接设计](docs/superpowers/specs/2026-07-20-reduce-survey-option-fatigue-design.md) | 选项压缩原则、ChemBlender 2.1 能力边界和验证标准 | 了解为何保留四道开发核心题 |
| [问卷选项减负实施计划](docs/superpowers/plans/2026-07-20-reduce-survey-option-fatigue.md) | 121 个选项的目标分布、同步范围和验证步骤 | 追溯本轮选项精简过程 |
...
本仓库是**调研资料包**，不包含 `.cube` → OpenVDB 转换器、Blender 插件或可执行代码。关键可视化、格式互操作、软件采用门槛和数值验证文献已完成全文核验，19 题、121 个封闭题选项的问卷已进入**文献支撑的预测试版**；正式投放前仍需用 10–15 人认知访谈覆盖亲自计算、合作、委托代算和结果使用者，检查角色分流、题目理解和实际完成时间。
